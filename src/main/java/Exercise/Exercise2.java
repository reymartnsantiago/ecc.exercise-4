...
public class Exercise2 {
	...
	public Exercise2(String filename) {
		this.path = filename;
		container = generateTable(new File(filename));

	}

	public Exercise2(File path) {
	...
	public static class ModelCell implements Comparable<ModelCell> {
		private String left;
		...
		@Override
		public int compareTo(Exercise2.ModelCell o) {
